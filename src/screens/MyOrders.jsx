          ...
          return (
            <View key={item.id} style={styles.cartItemCard}>
              ...
              <View style={styles.itemActions}>
                ...
                <Text style={styles.itemSavings}>Save UGX {itemSavings.toLocaleString()}</Text>
              </View>
            </View>
          );
        })}
...
const styles = StyleSheet.create({
  ...
  cartSummary: {
    backgroundColor: '#E8F5E9', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, alignItems: 'center',
  },
  cartItemCount: { fontSize: 11, color: '#006B3F', fontWeight: '600' },
  cartTotal: { fontSize: 15, fontWeight: '800', color: '#006B3F' },
  infoCard: {
    flexDirection: 'row', backgroundColor: '#F8F8F8', borderRadius: 16, padding: 14, marginBottom: 18,
  },
  infoLeft: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 },
  infoRight: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 },
  infoDivider: { width: 1, backgroundColor: '#E0E0E0', marginHorizontal: 10 },
  infoIcon: {
    width: 36, height: 36, borderRadius: 12,
    backgroundColor: '#E8F5E9', justifyContent: 'center', alignItems: 'center',
  },
  infoLabel: { fontSize: 10, color: '#888' },
  infoValue: { fontSize: 12, fontWeight: '700', color: '#212121' },
  cartItemCard: {
    flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 16, padding: 12, marginBottom: 10,
  ...
  itemName: { fontSize: 14, fontWeight: '700', color: '#212121', marginBottom: 2 },
  itemPack: { fontSize: 11, color: '#888', marginBottom: 4 },
  itemShopRow: { flexDirection: 'row', alignItems: 'center', gap: 3, marginBottom: 4 },
  itemShop: { fontSize: 11, color: '#888' },
  itemDistance: { fontSize: 10, color: '#888' },
  itemDiscountBadge: {
  ...
  itemActions: { alignItems: 'flex-end', justifyContent: 'center', gap: 4 },
  deleteBtn: { padding: 4 },
  itemMunolinkPrice: { fontSize: 14, fontWeight: '800', color: '#006B3F' },
  itemRegularPrice: { fontSize: 11, color: '#888', textDecorationLine: 'line-through' },
  qtyControls: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  qtyBtn: {
    width: 26, height: 26, borderRadius: 13,
    backgroundColor: '#F5F5F5', justifyContent: 'center', alignItems: 'center',
  },
  qtyValue: { fontSize: 13, fontWeight: '700', color: '#212121' },
  itemSavings: { fontSize: 9, color: '#006B3F', fontWeight: '600' },
  summaryCard: {
  ...
  summaryFinalLabel: { fontSize: 14, fontWeight: '700', color: '#212121' },
  summaryFinalValue: { fontSize: 18, fontWeight: '800', color: '#006B3F' },
  savingsMessage: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#E8F5E9', paddingHorizontal: 10, paddingVertical: 8,
    borderRadius: 10, marginTop: 10, gap: 6,
  },
  savingsMessageText: { fontSize: 12, color: '#006B3F', fontWeight: '600', flex: 1 },
  trustStrip: {
    flexDirection: 'row', justifyContent: 'space-between',
    backgroundColor: '#E8F5E9', borderRadius: 14, paddingVertical: 12, paddingHorizontal: 10,
    marginBottom: 20, flexWrap: 'wrap',
  },
  trustItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  trustText: { fontSize: 10, fontWeight: '600', color: '#006B3F' },
  sectionHeader: {
  ...
  recommendCard: {
    width: 130, backgroundColor: '#FFFFFF', borderRadius: 14, padding: 10, marginRight: 12,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1,
    position: 'relative',
  },
  recommendFav: { position: 'absolute', top: 8, right: 8, zIndex: 1 },
  recommendImage: {
    width: '100%', height: 70, backgroundColor: '#F5F5F5',
    borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginBottom: 8,
  },
  recommendName: { fontSize: 11, fontWeight: '600', color: '#212121', marginBottom: 4 },
  recommendPriceRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  recommendOldPrice: { fontSize: 10, color: '#888', textDecorationLine: 'line-through' },
  recommendNewPrice: { fontSize: 12, fontWeight: '700', color: '#006B3F' },
  recommendAddBtn: {
  ...
  saveLaterBtn: {
    flexDirection: 'row', alignItems: 'center',
    borderWidth: 1.5, borderColor: '#006B3F', paddingVertical: 12, paddingHorizontal: 16,
    borderRadius: 25, gap: 6,
  },
  saveLaterText: { fontSize: 13, fontWeight: '700', color: '#006B3F' },
  proceedBtn: {
    flex: 1, backgroundColor: '#006B3F', paddingVertical: 12, borderRadius: 25, alignItems: 'center', justifyContent: 'center',
  },
  proceedText: { fontSize: 14, fontWeight: '700', color: '#FFFFFF' },
  proceedSubtext: { fontSize: 9, color: 'rgba(255,255,255,0.7)', marginTop: 1 },
  bottomNav: {
